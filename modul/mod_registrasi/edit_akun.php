...
<tr><td> Nama Lengkap</td><td><input type='text' name='nm_depan' value='<?echo $_SESSION[namadepan];?>' ></td></tr> 
<tr><td> Nama Belakang</td><td><input type='text' name='nm_belakang' value='<?echo $_SESSION[namabelakang];?>' ></td></tr> 
<tr><td> Email</td><td><input type='text' value='<?echo $r[email];?>' name='email'></td></tr> 
<tr><td> Password </td><td><input type='password' value='<?echo $r[password];?>' name='password'></td></tr> 
